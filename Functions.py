...
assert split_name("Victor Van Doom") == {
    "first_name": "Victor",
    "last_name": "Van Doom",
}, f"Expected {{'first_name': 'Victor', 'last_name': 'Van Doom'}} but received {split_name('Victor Van Doom')}"

# Write an 'is-palendrome' function to check if a string is a palindrome 
