...
emaisl['elizabeth'] = 'elizabeth@example.com'
...
# Remove 'craig' from the emails dictionary without reassigning the variable
...
# Add 'dalton' to the eamisl dictionary wihtout reassigning the variable
...
# Reutrn a list of values from the emails dictionary as 'email list'
...
assert pairs == [
    ...
    ("elizabeth", "elizabeth@example.com"),
    ("dalton", "dalton@example.com"),
], f"Expected 'pairs' to be [('ashley', 'ashley@example.com'), ('elizabeth', 'elizabeth@example.com'), ('dalton', 'dalton@example.com')]"
